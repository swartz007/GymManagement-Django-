...
def Add_Equipment(request):
    ...
    if request.method == "POST":
        ...
        try:
            Equipment.objects.create(name=n, price=p,unit=u, date1=d,description=de)
            error = "no"
        except:
            error = "yes"
    d = {'equipment': equipment, 'error': error}
...
def Add_Member(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            error = "yes"
    d = {'member': member,'plan': plan1, 'error': error}
